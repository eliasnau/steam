...
type DevelopersListResponse = InferClientOutputs<
	typeof client
>["developers"]["list"];
type DeveloperRow = DevelopersListResponse["data"][number];
...
const createColumns = (): ColumnDef<DeveloperRow>[] => [
	{
		accessorKey: "name",
		header: "Name",
	},
			...
			return (
				<div className="flex items-center justify-end gap-2">
					<Menu>
						...
						<MenuPopup align="end">
							<MenuItem
								onClick={() => console.log("Entwickler anzeigen:", developer)}
							>
								Anzeigen
							</MenuItem>
							<MenuItem
								onClick={() => console.log("Entwickler bearbeiten:", developer)}
							>
								Bearbeiten
							</MenuItem>
							<MenuItem
								variant="destructive"
								onClick={() => console.log("Entwickler löschen:", developer)}
							>
								Löschen
							</MenuItem>
						</MenuPopup>
				...
				<FramePanel className="py-12">
					<Empty>
						<EmptyHeader>
							...
							<EmptyTitle>Noch keine Entwickler</EmptyTitle>
							<EmptyDescription>
								Füge deinen ersten Entwickler hinzu, um loszulegen.
							</EmptyDescription>
						</EmptyHeader>
					</Empty>
				</FramePanel>
							...
							<TableCell colSpan={columns.length} className="h-32 text-center">
								<div className="flex flex-col items-center justify-center gap-2">
									<p className="text-muted-foreground">
										{search
											? "Keine Entwickler gefunden, die deiner Suche entsprechen."
						...
						<TableCell colSpan={columns.length} className="p-2">
							<div className="flex items-center justify-between gap-2">
								<div className="flex items-center gap-2 whitespace-nowrap">
									<p className="text-muted-foreground text-sm">Anzeigen</p>
									<Select
										items={[
											{ label: "10", value: 10 },
											{ label: "20", value: 20 },
									...
									<span className="text-muted-foreground text-sm">
										...
										{pagination.totalCount === 1 ? "Entwickler" : "Entwicklern"}
									</span>
								</div>
