...
type GenresListResponse = InferClientOutputs<typeof client>["genres"]["list"];
type GenreRow = GenresListResponse["data"][number];
...
const createColumns = (): ColumnDef<GenreRow>[] => [
	{
		accessorKey: "name",
		header: "Name",
	},
			...
			return (
				<div className="flex items-center justify-end gap-2">
					<Menu>
						...
						/>
						<MenuPopup align="end">
							<MenuItem onClick={() => console.log("Genre ansehen:", genre)}>
								Ansehen
							</MenuItem>
							<MenuItem onClick={() => console.log("Genre bearbeiten:", genre)}>
								Bearbeiten
							</MenuItem>
							<MenuItem
								variant="destructive"
								onClick={() => console.log("Genre löschen:", genre)}
							>
								Löschen
							</MenuItem>
						</MenuPopup>
				...
				<FramePanel className="py-12">
					<Empty>
						<EmptyHeader>
							...
							<EmptyTitle>Noch keine Genres</EmptyTitle>
							<EmptyDescription>
								Fügen Sie Ihr erstes Genre hinzu, um loszulegen.
							</EmptyDescription>
						</EmptyHeader>
					</Empty>
				</FramePanel>
							...
							<TableCell colSpan={columns.length} className="h-32 text-center">
								<div className="flex flex-col items-center justify-center gap-2">
									<p className="text-muted-foreground">
										{search
											? "Keine Genres gefunden, die Ihrer Suche entsprechen."
							...
							<div className="flex items-center justify-between gap-2">
								<div className="flex items-center gap-2 whitespace-nowrap">
									...
									<span className="text-muted-foreground text-sm">
										...
										{pagination.totalCount === 1 ? "Genre" : "Genres"}
									</span>
								</div>
