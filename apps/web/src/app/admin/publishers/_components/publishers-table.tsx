...
type PublishersListResponse = InferClientOutputs<
	typeof client
>["publishers"]["list"];
type PublisherRow = PublishersListResponse["data"][number];
...
const createColumns = (): ColumnDef<PublisherRow>[] => [
	{
		accessorKey: "name",
		header: "Name",
	},
			...
			return (
				<div className="flex items-center justify-end gap-2">
					<Menu>
						...
						<MenuPopup align="end">
							<MenuItem
								onClick={() => console.log("Publisher ansehen:", publisher)}
							>
								Ansehen
							</MenuItem>
							<MenuItem
								onClick={() => console.log("Publisher bearbeiten:", publisher)}
							>
								Bearbeiten
							</MenuItem>
							<MenuItem
								variant="destructive"
								onClick={() => console.log("Publisher löschen:", publisher)}
							>
								Löschen
							</MenuItem>
						</MenuPopup>
				...
				<FramePanel className="py-12">
					<Empty>
						<EmptyHeader>
							...
							<EmptyTitle>Noch keine Publisher</EmptyTitle>
							<EmptyDescription>
								Beginne jetzt, indem du deinen ersten Publisher hinzufügst.
							</EmptyDescription>
						</EmptyHeader>
					</Empty>
				</FramePanel>
							...
							<TableCell colSpan={columns.length} className="h-32 text-center">
								<div className="flex flex-col items-center justify-center gap-2">
									<p className="text-muted-foreground">
										{search
											? "Keine Publisher für die Suche gefunden."
							...
							<div className="flex items-center justify-between gap-2">
								<div className="flex items-center gap-2 whitespace-nowrap">
									...
									<span className="text-muted-foreground text-sm">
										...
										{pagination.totalCount === 1 ? "Publisher" : "Publisher"}
									</span>
								</div>
